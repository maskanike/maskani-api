module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    try {
      await queryInterface.addColumn('Tenants', 'name', { type: Sequelize.STRING }, { transaction });
      await queryInterface.addColumn('Tenants', 'email', { type: Sequelize.STRING }, { transaction });
