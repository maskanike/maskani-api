module.exports = {
  ...
  async down(queryInterface) {
    ...
    try {
      ...
      await queryInterface.sequelize.query(queryInterface.QueryGenerator.pgEnumDrop('Tenants', 'paymentStatus'), { transaction });
      ...
      await queryInterface.sequelize.query(queryInterface.QueryGenerator.pgEnumDrop('Invoices', 'status'), { transaction });
      await transaction.commit();
    } catch (err) {
      await transaction.rollback();
      throw err;
